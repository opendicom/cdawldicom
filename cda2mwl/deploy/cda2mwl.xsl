...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:template match="/cita">
        ...
        <xsl:call-template name="nextKeyValue">
            <xsl:with-param name="key">00000001-00100010_PN</xsl:with-param>
        ...
        <!-- PID-3 PatientID-->
        <xsl:call-template name="nextKeyValue">
            <xsl:with-param name="key">00000001-00100020_LO</xsl:with-param>
        ...
        <xsl:choose>
            <xsl:when test="@fkOidP = ''">
                <xsl:call-template name="nextKeyValue">
                    <xsl:with-param name="key">00000001-00100021_LO</xsl:with-param>
        ...
        <xsl:call-template name="nextKeyValue">
            <xsl:with-param name="key">00000001-00321032_PN</xsl:with-param>
        ...
        <xsl:call-template name="nextKeyValue">
            <xsl:with-param name="key">00000001-00400100.00000001-00400009_SH</xsl:with-param>
        ...
        <xsl:call-template name="nextKeyValue">
            <xsl:with-param name="key">00000001-00400100.00000001-00400010_SH</xsl:with-param>
            <xsl:with-param name="value" select="'UNKNOWN'"/>
        </xsl:call-template>
        ...
        <xsl:call-template name="nextKeyValue">
            <xsl:with-param name="key">00000001-00401001_SH</xsl:with-param>
        ...
        <xsl:call-template name="nextKeyValue">
            <xsl:with-param name="key">00000001-00402016_LO</xsl:with-param>
            <xsl:with-param name="value" select="substring(@pkStudyUID,string-length(@pkStudyUID)-15,16)"/>
        </xsl:call-template>
        ...
        <xsl:call-template name="nextKeyValue">
            <xsl:with-param name="key">00000001-00402017_LO</xsl:with-param>
            <xsl:with-param name="value" select="@pkPaso"/>
        </xsl:call-template>
